...
public enum Menu {
  ...
  // SML_MENU3_1("SM30001", squareTwo(31), "소메뉴3-1"), // int 범위 초과
  ;
  ...
  static Menu[] menuArray = Menu.values();

  Menu(String menuCode, int menuValue, String menuName) {
  ...
  public static int squareTwo(int squareCount) {
    return (int) Math.pow(2, squareCount);
  }

  public static Map<String, String> getUserMenus(int userAthorityCode) {
    ...
    List<Menu> menuList = Arrays.asList(menuArray);
  ...
  public static boolean hasPermission(int userPermissions, int permissionToCheck) {
    ...
    System.out.println(Integer.toBinaryString(userPermissions));
    System.out.println(Integer.toBinaryString(permissionToCheck));
    System.out.println(Integer.toBinaryString((userPermissions & permissionToCheck)));
